...
image_filenames = ['pickup_truck.png', 'semi_trailer.png', 'taxi.png', 'van.png', 'Black_viper.png', 'Police.png', 'Ambulance.png']
vehicle_images = []
...
while running:
    ...
    for vehicle in vehicle_group:
        ...
        if vehicle.rect.top >= height:
            ...
            # speed up the game after passing 5 vehicle
    ...
    # chechk if player wants to play again
    while gameover:
